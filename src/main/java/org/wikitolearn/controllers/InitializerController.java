...
//					.allOf(pageService.addAllPages(lang, url), userService.addAllUsers(url))
//					.thenCompose(s -> revisionService.addAllRevisions(lang, url));
//			initTasks.add(task);
//		}
//		try {
//			CompletableFuture<List<Boolean>> allFutures = aggregateFutures(initTasks);
//			// saving the result of the process
...
//
//	/**
//	 * This methods initializes all vertex and edge types in the database
//	 */
//	private void initializeDbClasses() {
//		LOG.info("Creating Database classes...");
//		metadataDAO.createDatabaseClass();
...
//	}
//		
//	private static <T> CompletableFuture<List<T>> aggregateFutures(List<CompletableFuture<T>> futures) {

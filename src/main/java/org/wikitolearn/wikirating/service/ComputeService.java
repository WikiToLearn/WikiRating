...
public class ComputeService {
    ...
    @Async
    public CompletableFuture<Boolean> calculateRevisionsPoints(String langPageId){
        // Get all the revision ordered from the oldest
        Set<Revision> revisions = revisionService.getRevisionsOfPageOrdered(langPageId);
